...
class PengajarKelolaMateri extends StatefulWidget {
  final String mataPelajaran;
  final Color warna;
  final IconData icon;

  const PengajarKelolaMateri({
    super.key,
  ...
  @override
  State<PengajarKelolaMateri> createState() => _PengajarKelolaMateriState();
}

class _PengajarKelolaMateriState extends State<PengajarKelolaMateri> {
  ...
  Widget _buildHeaderStats() {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _buildStatItem(Icons.file_copy, '${_materiList.length}', 'Total Materi'),
          Container(
            width: 1,
            height: 40,
